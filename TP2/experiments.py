...
def run_text2img_experiments() -> None:
    ...
    seed = 42
    prompt = "professional product photography of a futuristic running sneaker, vibrant orange and white, floating, white background, soft studio lighting, highly detailed, 8k, sharp focus"  # TODO: choisissez un prompt e-commerce en anglais unique et gardez-le identique pour tous les runs
...
def run_img2img_experiments() -> None:
    ...
    init_path = "TP2/inputs/montre.jpg"  # ex: "my_product.jpg"

    prompt = "professional product photography of the luxury chronograph watch, polished gold case, rich brown leather strap with white stitching, black dial with gold accents, studio lighting, isolated on white background, high resolution, 8k"   # TODO: prompt e-commerce (en anglais)
    negative = "text, watermark, logo, low quality, blurry, deformed"
